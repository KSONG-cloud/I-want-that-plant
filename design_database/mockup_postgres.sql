...
ALTER TABLE "favorites" ADD FOREIGN KEY ("listings_id") REFERENCES "listings" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "listings" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id") DEFERRABLE INITIALLY IMMEDIATE;
